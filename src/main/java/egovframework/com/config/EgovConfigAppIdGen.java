...
public class EgovConfigAppIdGen {
	...
	/** 출퇴근관리 ID Generation Config */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovCmtManageIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource)
			.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
			.setBlockSize(10).setTable("COMTECOPSEQ").setTableName("WRKTM_ID")
			.setPreFix("WRKTM_").setCipers(14).setFillChar('0').build();
	}

	/** 약도관리 ID Generation Config */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovRoughMapIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(egovDataSource)
			.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
			.setBlockSize(10)
			.setTable("COMTECOPSEQ")
	...
	/** 댓글 답변번호 생성기 (cop/cmt) — getNextLongId 사용 */
	@Bean(destroyMethod = "destroy")
	...
	/** 지식맵 팀 ID 생성기 (dam/map/tea) */
	@Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovMapTeamIdGnrService() {
		return new EgovIdGnrBuilder().setDataSource(dataSource).setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
			.setBlockSize(10).setTable("COMTECOPSEQ").setTableName("MAPTEAM_ID").setPreFix("TEAM_").setCipers(15).setFillChar('0').build();
	}
