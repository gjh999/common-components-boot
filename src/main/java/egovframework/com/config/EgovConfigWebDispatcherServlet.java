...
public class EgovConfigWebDispatcherServlet implements WebMvcConfigurer {
	...
	/**
	 * 쪽지(uss/ion/nts·ntm·ntr) 등에서 사용하는 EgovSecurityMap 파라미터를 처리하는
	 * EgovSecurityArgumentResolver 등록. (암호화 ID 복호화 — 데모는 passthrough)
	 */
	@Override
	public void addArgumentResolvers(List<org.springframework.web.method.support.HandlerMethodArgumentResolver> resolvers) {
		resolvers.add(new egovframework.com.cmm.resolver.EgovSecurityArgumentResolver());
	}
}
