...
public class EgovMeetingManageController {
    ...
    public String egovMeetingManageMain(ModelMap model) throws Exception {
    	return "com/uss/olp/mgt/EgovMeetingManageMain";
    }
    ...
    public String egovMeetingManageLeft(ModelMap model) throws Exception {
    	return "com/uss/olp/mgt/EgovMeetingManageLeft";
    }
    ...
    public String egovMain(ModelMap model) throws Exception {
    	return "com/uss/olp/mgt/EgovMain";
    }
    ...
    public String egovLeft(ModelMap model) throws Exception {
    	return "com/uss/olp/mgt/EgovLeft";
    }
     ...
     * @param commandMap
     * @param model
     * @return "com/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopup"
     * @throws Exception
     */
    ...
    throws Exception {
    	...
    	return "com/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup";
    }
	 ...
	 * @param model
	 * @return "com/uss/olp/mgt/EgovMeetingManageList"
	 * @throws Exception
	 */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "com/uss/olp/mgt/EgovMeetingManageDetail"
	 * @throws Exception
	 */
	...
	public String meetingManageModifyView(
		...
		return "com/uss/olp/mgt/EgovMeetingManageModify";
	}
    ...
    throws Exception {
		...
		return "com/uss/olp/mgt/EgovMeetingManageRegist";
	}
