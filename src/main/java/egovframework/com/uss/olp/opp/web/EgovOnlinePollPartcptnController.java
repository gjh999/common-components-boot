...
public class EgovOnlinePollPartcptnController {
	 ...
	 * @param model
	 * @return "com/uss/olp/opp/EgovOnlinePollList"
	 * @throws Exception
	 */
...
//        String sSearchMode = commandMap.get("searchMode") == null ? "" : (String) commandMap.get("searchMode");
		...
		return "com/uss/olp/opp/EgovOnlinePollPartcptnMainList";
	}
...
//        String sSearchMode = commandMap.get("searchMode") == null ? "" : (String) commandMap.get("searchMode");
		...
		return "com/uss/olp/opp/EgovOnlinePollPartcptnList";
	}
...
//        List<?> listPollDeuseYn = new ArrayList<Object>();
		...
		return "com/uss/olp/opp/EgovOnlinePollPartcptnStatistics";
	}
