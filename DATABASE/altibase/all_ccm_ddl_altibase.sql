...
CREATE TABLE TB_INTNET_SVC (
  ...
  INTNET_SVC_DC varchar(4000),  -- 인터넷서비스설명
...
CREATE TABLE TB_RECOMEND_SITE_INFO (
  ...
  RECOMEND_SITE_DC varchar(4000),  -- 추천사이트설명
  RECOMEND_RESN_CN varchar(4000),  -- 추천사유내용
...
CREATE TABLE TB_UNITY_LINK (
  ...
  UNITY_LINK_DC varchar(4000),  -- 통합링크설명
  FRST_REGIST_PNTTM date,  -- 최초등록시각
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  LAST_UPDT_PNTTM date,  -- 최종수정시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
...
CREATE TABLE TB_ADMINISTRATION_WORD (
  ...
  ADMINIST_WORD_DFN varchar(4000),  -- 행정단어정의
  ADMINIST_WORD_DC varchar(4000),  -- 행정단어설명
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM date,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM date,  -- 최종수정시각
...
CREATE TABLE TB_MTG_INFO (
  ...
  MTG_MTR_CN varchar(4000),  -- 회의원동기내용
  ...
  READNG_AT varchar(1) DEFAULT 'N',  -- READNG여부
  MTG_RESULT_CN varchar(4000),  -- 회의결과내용
  MTG_RESULT_ENNC varchar(200),  -- 회의결과암호
  ETC_MATTER varchar(4000),  -- 기타MATTER
...
CREATE TABLE TB_EVENT_INFO (
  ...
  PRPARETG_CN varchar(4000),  -- PRPARETG내용
...
CREATE TABLE TB_ONLINE_POLL_MANAGE (
  ...
  QESITM_CN varchar(4000),  -- QESITM내용
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM date,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM date,  -- 최종수정시각
...
CREATE TABLE TB_ONLINE_MANUAL (
  ...
  ONLINE_MNL_DC varchar(4000),  -- 온라인매뉴얼설명
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM date,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM date,  -- 최종수정시각
...
CREATE TABLE TB_CPYRHT_INFO (
  ...
  CPYRHT_PRTC_POLICY_CN varchar(4000),  -- 저작권보호정책내용
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM date,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM date,  -- 최종수정시각
