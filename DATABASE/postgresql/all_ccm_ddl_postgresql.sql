...
-- ============================================================
-- common-components-boot Postgresql DDL (shtdb.sql HSQL 정본에서 생성)
-- 명명규칙: TB_ + snake_case / 감사컬럼 4종(FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID)
-- 사용: postgresql 에 적재 (DB명 예: ccm)
-- ============================================================

DROP VIEW IF EXISTS VW_USER_MASTER CASCADE;
DROP TABLE IF EXISTS TB_MEMO_TODO CASCADE;
DROP TABLE IF EXISTS TB_COMMENT CASCADE;
DROP TABLE IF EXISTS TB_ADBK_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_DAM_KNO_IFM CASCADE;
DROP TABLE IF EXISTS TB_NCRD CASCADE;
DROP TABLE IF EXISTS TB_BATCH_RESULT CASCADE;
DROP TABLE IF EXISTS TB_BATCH_SCHDUL CASCADE;
DROP TABLE IF EXISTS TB_BATCH_OPERT CASCADE;
DROP TABLE IF EXISTS TB_CNSLT_LIST CASCADE;
DROP TABLE IF EXISTS TB_CPYRHT_INFO CASCADE;
DROP TABLE IF EXISTS TB_ONLINE_MANUAL CASCADE;
DROP TABLE IF EXISTS TB_ONLINE_POLL_IEM CASCADE;
DROP TABLE IF EXISTS TB_ONLINE_POLL_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_BNDT_CECK_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_BNDT_DIARY CASCADE;
DROP TABLE IF EXISTS TB_BNDT_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_VCATN_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_EVENT_INFO CASCADE;
DROP TABLE IF EXISTS TB_RECENT_SRCHWRD CASCADE;
DROP TABLE IF EXISTS TB_RECENT_SRCHWRD_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_MTG_INFO CASCADE;
DROP TABLE IF EXISTS TB_ANNVRSRY_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_INDVDL_YRYC_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_NOTE_RECPTN CASCADE;
DROP TABLE IF EXISTS TB_NOTE_TRNSMIT CASCADE;
DROP TABLE IF EXISTS TB_NOTE CASCADE;
DROP TABLE IF EXISTS TB_ADMINISTRATION_WORD CASCADE;
DROP TABLE IF EXISTS TB_COMMUTE CASCADE;
DROP TABLE IF EXISTS TB_HPCM_INFO CASCADE;
DROP TABLE IF EXISTS TB_INDVDL_PGE_CNTNTS CASCADE;
DROP TABLE IF EXISTS TB_WORD_DICARY_INFO CASCADE;
DROP TABLE IF EXISTS TB_MTG_PLACE_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_LOGIN_SCRIN_IMAGE CASCADE;
DROP TABLE IF EXISTS TB_MAIN_IMAGE CASCADE;
DROP TABLE IF EXISTS TB_NEWS_INFO CASCADE;
DROP TABLE IF EXISTS TB_RWARD_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_EVENT_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_WIKI_BKMK CASCADE;
DROP TABLE IF EXISTS TB_POPUP_MANAGE CASCADE;
DROP TABLE IF EXISTS TB_SITE_LIST CASCADE;
DROP TABLE IF EXISTS TB_UNITY_LINK CASCADE;
DROP TABLE IF EXISTS TB_ROUGHMAP CASCADE;
DROP TABLE IF EXISTS TB_RECOMEND_SITE_INFO CASCADE;
DROP TABLE IF EXISTS TB_INTNET_SVC CASCADE;
DROP TABLE IF EXISTS TB_NTFC_INFO CASCADE;
DROP TABLE IF EXISTS TB_RSS CASCADE;
DROP TABLE IF EXISTS TB_CTSNN_MANAGE CASCADE;
...
CREATE TABLE TB_RECOMEND_SITE_INFO (
  ...
  RECOMEND_SITE_DC text,  -- 추천사이트설명
  RECOMEND_RESN_CN text,  -- 추천사유내용
...
CREATE TABLE TB_ADMINISTRATION_WORD (
  ...
  ADMINIST_WORD_DFN text,  -- 행정단어정의
  ADMINIST_WORD_DC text,  -- 행정단어설명
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM timestamp,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM timestamp,  -- 최종수정시각
...
CREATE TABLE TB_MTG_INFO (
  ...
  READNG_AT varchar(1) DEFAULT 'N',  -- READNG여부
  MTG_RESULT_CN text,  -- 회의결과내용
  MTG_RESULT_ENNC varchar(200),  -- 회의결과암호
  ETC_MATTER text,  -- 기타MATTER
...
CREATE TABLE TB_CPYRHT_INFO (
  ...
  CPYRHT_PRTC_POLICY_CN text,  -- 저작권보호정책내용
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM timestamp,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM timestamp,  -- 최종수정시각
