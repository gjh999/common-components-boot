...
NTCN_NO NUMERIC(10) NOT NULL, NTCN_SJ varchar(200), NTCN_CN text, NTCN_TM varchar(20),
...
INTNET_SVC_ID varchar(20) NOT NULL, INTNET_SVC_NM varchar(200), INTNET_SVC_DC text,
...
RECOMEND_SITE_ID varchar(20) NOT NULL, RECOMEND_SITE_URL varchar(300), RECOMEND_SITE_NM varchar(200),
  RECOMEND_SITE_DC text, RECOMEND_RESN_CN text, RECOMEND_CONFM_AT varchar(1) DEFAULT 'N',
...
ROUGHMAP_ID varchar(20) NOT NULL, ROUGHMAPSJ varchar(200), ROUGHMAPADDRESS varchar(300),
  LA varchar(30), LO varchar(30), MARKERLA varchar(30), MARKERLO varchar(30), INFOWINDOW text, ZOOMLEVEL varchar(5),
...
UNITY_LINK_ID varchar(20) NOT NULL, UNITY_LINK_SE_CODE varchar(20), UNITY_LINK_NM varchar(200),
  UNITY_LINK_URL varchar(300), UNITY_LINK_DC text,
  FRST_REGIST_PNTTM timestamp, FRST_REGISTER_ID varchar(20), LAST_UPDT_PNTTM timestamp, LAST_UPDUSR_ID varchar(20),
  PRIMARY KEY (UNITY_LINK_ID)
);
CREATE TABLE TB_SITE_LIST (
SITE_ID varchar(20) NOT NULL, SITE_URL varchar(300), SITE_NM varchar(200), SITE_DC text,
...
EVENT_ID varchar(20) NOT NULL, EVENT_SE varchar(20), EVENT_NM varchar(200), EVENT_PURPS text,
  EVENT_BGNDE varchar(20), EVENT_ENDDE varchar(20), EVENT_AUSPC_INSTT_NM varchar(100), EVENT_MNGT_INSTT_NM varchar(100),
  EVENT_PLACE varchar(200), EVENT_CN text, CT_OCCRRNC_AT varchar(1) DEFAULT 'N', PARTCPT_CT varchar(100),
...
RWARD_ID varchar(20) NOT NULL, RWARDWNR_ID varchar(20), RWARD_CODE varchar(20), RWARD_DE varchar(20), RWARD_NM varchar(200),
  PBLEN_CN text, SANCTNER_ID varchar(20), CONFM_AT varchar(1) DEFAULT 'N', SANCTN_DT varchar(20), RETURN_RESN text,
  ATCH_FILE_ID varchar(20), INFRML_SANCTN_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (RWARD_ID)
);
CREATE TABLE TB_NEWS_INFO (
NEWS_ID varchar(20) NOT NULL, NEWS_SJ varchar(200), NEWS_CN text, NEWS_ORIGIN varchar(200),
...
IMAGE_ID varchar(20) NOT NULL, IMAGE_NM varchar(200), IMAGE varchar(300), IMAGE_FILE varchar(300),
  IMAGE_DC text, REFLCT_AT varchar(1) DEFAULT 'N',
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
...
WORD_ID varchar(20) NOT NULL, WORD_NM varchar(200), ENG_NM varchar(200), WORD_DC text, SYNONM varchar(300),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (WORD_ID)
);
...
CNTNTS_ID varchar(20) NOT NULL, CNTNTS_NM varchar(200), CNTC_URL varchar(300), CNTNTS_USE_AT varchar(1) DEFAULT 'Y',
  CNTNTS_LINK_URL varchar(300), CNTNTS_DC text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (CNTNTS_ID)
);
CREATE TABLE TB_HPCM_INFO (
HPCM_ID varchar(20) NOT NULL, HPCM_SE_CODE varchar(20), HPCM_DFN varchar(300), HPCM_DC text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (HPCM_ID)
);
...
ADMINIST_WORD_ID varchar(20) NOT NULL, ADMINIST_WORD_NM varchar(200), ADMINIST_WORD_ENG_NM varchar(200),
  ...
  ADMINIST_WORD_DFN text, ADMINIST_WORD_DC text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (ADMINIST_WORD_ID)
);
CREATE TABLE TB_NOTE (
NOTE_ID varchar(20) NOT NULL, NOTE_SJ varchar(200), NOTE_CN text, ATCH_FILE_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (NOTE_ID)
);
...
ANNVRSRY_ID varchar(20) NOT NULL, USER_ID varchar(20), ANNVRSRY_SE varchar(20), ANNVRSRY_NM varchar(200),
  ...
  MEMO text, REPTIT_AT varchar(1) DEFAULT 'N',
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (ANNVRSRY_ID)
);
CREATE TABLE TB_MTG_INFO (
MTG_ID varchar(20) NOT NULL, MTG_NM varchar(200), MTG_MTR_CN text, MTG_SN varchar(20), MTG_CO varchar(20),
  ...
  MTG_RESULT_CN text, MTG_RESULT_ENNC varchar(200), ETC_MATTER text,
...
EVENT_ID varchar(20) NOT NULL, BSNS_YEAR varchar(4), BSNS_CODE varchar(20),
  ...
  EVENT_CN text, EVENT_TY_CODE varchar(20), PRPARETG_CN text, EVENT_CONFM_AT varchar(1) DEFAULT 'N', EVENT_CONFM_DE varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (EVENT_ID)
);
...
POLL_ID varchar(20) NOT NULL, POLL_NM varchar(200), POLL_BGNDE varchar(20), POLL_ENDDE varchar(20),
  POLL_KND varchar(20), POLL_DSUSE_ENNC varchar(1) DEFAULT 'N', POLL_ATMC_DSUSE_ENNC varchar(1) DEFAULT 'N', QESITM_CN text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (POLL_ID)
);
...
ONLINE_MNL_ID varchar(20) NOT NULL, ONLINE_MNL_NM varchar(200), ONLINE_MNL_SE_CODE varchar(20),
  ONLINE_MNL_DFN varchar(500), ONLINE_MNL_DC text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (ONLINE_MNL_ID)
);
CREATE TABLE TB_CPYRHT_INFO (
CPYRHT_ID varchar(20) NOT NULL, CPYRHT_PRTC_POLICY_CN text,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (CPYRHT_ID)
);
CREATE TABLE TB_CNSLT_LIST (
CNSLT_ID varchar(20) NOT NULL, CNSLT_SJ varchar(200), CNSLT_CN text, OTHBC_AT varchar(1) DEFAULT 'Y',
...
KNWLDG_ID varchar(20) NOT NULL, KNWLDG_NM varchar(200), KNWLDG_CN text, KNWLDG_TY_CODE varchar(20),
...
TODO_ID varchar(20) NOT NULL, TODO_SJ varchar(200), TODO_CN text, TODO_BEGIN_TIME varchar(20), TODO_END_TIME varchar(20), WRTER_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM timestamp, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM timestamp,
  PRIMARY KEY (TODO_ID)
);
