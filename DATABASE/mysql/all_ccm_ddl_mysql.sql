...
-- 사용: mysql 에 적재 (DB명 예: ccm)
-- ============================================================

DROP VIEW IF EXISTS VW_USER_MASTER;
DROP TABLE IF EXISTS TB_MEMO_TODO;
DROP TABLE IF EXISTS TB_COMMENT;
DROP TABLE IF EXISTS TB_ADBK_MANAGE;
DROP TABLE IF EXISTS TB_DAM_KNO_IFM;
DROP TABLE IF EXISTS TB_NCRD;
DROP TABLE IF EXISTS TB_BATCH_RESULT;
DROP TABLE IF EXISTS TB_BATCH_SCHDUL;
DROP TABLE IF EXISTS TB_BATCH_OPERT;
DROP TABLE IF EXISTS TB_CNSLT_LIST;
DROP TABLE IF EXISTS TB_CPYRHT_INFO;
DROP TABLE IF EXISTS TB_ONLINE_MANUAL;
DROP TABLE IF EXISTS TB_ONLINE_POLL_IEM;
DROP TABLE IF EXISTS TB_ONLINE_POLL_MANAGE;
DROP TABLE IF EXISTS TB_BNDT_CECK_MANAGE;
DROP TABLE IF EXISTS TB_BNDT_DIARY;
DROP TABLE IF EXISTS TB_BNDT_MANAGE;
DROP TABLE IF EXISTS TB_VCATN_MANAGE;
DROP TABLE IF EXISTS TB_EVENT_INFO;
DROP TABLE IF EXISTS TB_RECENT_SRCHWRD;
DROP TABLE IF EXISTS TB_RECENT_SRCHWRD_MANAGE;
DROP TABLE IF EXISTS TB_MTG_INFO;
DROP TABLE IF EXISTS TB_ANNVRSRY_MANAGE;
DROP TABLE IF EXISTS TB_INDVDL_YRYC_MANAGE;
DROP TABLE IF EXISTS TB_NOTE_RECPTN;
DROP TABLE IF EXISTS TB_NOTE_TRNSMIT;
DROP TABLE IF EXISTS TB_NOTE;
DROP TABLE IF EXISTS TB_ADMINISTRATION_WORD;
DROP TABLE IF EXISTS TB_COMMUTE;
DROP TABLE IF EXISTS TB_HPCM_INFO;
DROP TABLE IF EXISTS TB_INDVDL_PGE_CNTNTS;
DROP TABLE IF EXISTS TB_WORD_DICARY_INFO;
DROP TABLE IF EXISTS TB_MTG_PLACE_MANAGE;
DROP TABLE IF EXISTS TB_LOGIN_SCRIN_IMAGE;
DROP TABLE IF EXISTS TB_MAIN_IMAGE;
DROP TABLE IF EXISTS TB_NEWS_INFO;
DROP TABLE IF EXISTS TB_RWARD_MANAGE;
DROP TABLE IF EXISTS TB_EVENT_MANAGE;
DROP TABLE IF EXISTS TB_WIKI_BKMK;
DROP TABLE IF EXISTS TB_POPUP_MANAGE;
DROP TABLE IF EXISTS TB_SITE_LIST;
DROP TABLE IF EXISTS TB_UNITY_LINK;
DROP TABLE IF EXISTS TB_ROUGHMAP;
DROP TABLE IF EXISTS TB_RECOMEND_SITE_INFO;
DROP TABLE IF EXISTS TB_INTNET_SVC;
DROP TABLE IF EXISTS TB_NTFC_INFO;
DROP TABLE IF EXISTS TB_RSS;
DROP TABLE IF EXISTS TB_CTSNN_MANAGE;
DROP TABLE IF EXISTS TB_STPLAT_INFO;
DROP TABLE IF EXISTS TB_QUSTNR_RSPNS_RESULT;
DROP TABLE IF EXISTS TB_QUSTNR_RESPOND_INFO;
DROP TABLE IF EXISTS TB_QUSTNR_IEM;
DROP TABLE IF EXISTS TB_QUSTNR_QESITM;
DROP TABLE IF EXISTS TB_QESTNR_INFO;
DROP TABLE IF EXISTS TB_QUSTNR_TMPLAT;
DROP TABLE IF EXISTS TB_MENU_CREAT_DTLS;
DROP TABLE IF EXISTS TB_MENU_INFO;
DROP TABLE IF EXISTS TB_PROGRM_LIST;
DROP TABLE IF EXISTS TB_INDVDL_INFO_POLICY;
DROP TABLE IF EXISTS TB_BANNER;
DROP TABLE IF EXISTS TB_ZIP;
DROP TABLE IF EXISTS TB_AUTHOR_ROLE_RELATE;
...
CREATE TABLE TB_ZIP (
  ...
  SN decimal(10,0) DEFAULT '0' NOT NULL,  -- 일련번호
...
CREATE TABLE TB_RSS (
  ...
  TRGET_SVC_LIST_CO decimal(6),  -- 대상서비스목록수
...
CREATE TABLE TB_NTFC_INFO (
  NTCN_NO decimal(10) NOT NULL,  -- 알림번호
...
CREATE TABLE TB_RECOMEND_SITE_INFO (
  ...
  RECOMEND_SITE_DC longtext,
  RECOMEND_RESN_CN longtext,
...
CREATE TABLE TB_MTG_PLACE_MANAGE (
  ...
  ACEPTNC_POSBL_NMPR decimal(6),  -- 수용가능인원
...
CREATE TABLE TB_ADMINISTRATION_WORD (
  ...
  ADMINIST_WORD_DFN longtext,
  ADMINIST_WORD_DC longtext,
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM datetime,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM datetime,  -- 최종수정시각
...
CREATE TABLE TB_INDVDL_YRYC_MANAGE (
  ...
  YRYC_OCCRRNC_CO decimal(5,1),  -- 연차발생수
  USE_YRYC_CO decimal(5,1),  -- 사용연차수
  REMNDR_YRYC_CO decimal(5,1),  -- REMNDR연차수
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM datetime,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM datetime,  -- 최종수정시각
...
CREATE TABLE TB_MTG_INFO (
  ...
  NONATDRN_CO decimal(6),  -- NONATDRN수
  ATDRN_CO decimal(6),  -- ATDRN수
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM datetime,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM datetime,  -- 최종수정시각
...
CREATE TABLE TB_RECENT_SRCHWRD (
  ...
  SRCHWRD_CO decimal(10) DEFAULT 0,  -- 검색어수
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM datetime,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM datetime,  -- 최종수정시각
...
CREATE TABLE TB_CPYRHT_INFO (
  ...
  CPYRHT_PRTC_POLICY_CN longtext,
  FRST_REGISTER_ID varchar(20),  -- 최초등록자ID
  FRST_REGIST_PNTTM datetime,  -- 최초등록시각
  LAST_UPDUSR_ID varchar(20),  -- 최종수정자ID
  LAST_UPDT_PNTTM datetime,  -- 최종수정시각
...
CREATE TABLE TB_COMMENT (
  ANSWER_NO decimal(20) NOT NULL,  -- 답변번호
  NTT_ID decimal(20) NOT NULL,  -- 게시물ID
