...
RSS_ID varchar(20) NOT NULL, TRGET_SVC_NM varchar(100), TRGET_SVC_TABLE varchar(100),
  TRGET_SVC_LIST_CO decimal(6), HDER_TITLE varchar(200), HDER_LINK varchar(200), HDER_DC varchar(500),
  ...
  FRST_REGIST_PNTTM datetime, FRST_REGISTER_ID varchar(20), LAST_UPDT_PNTTM datetime, LAST_UPDUSR_ID varchar(20),
  PRIMARY KEY (RSS_ID)
);
CREATE TABLE TB_NTFC_INFO (
NTCN_NO decimal(10) NOT NULL, NTCN_SJ varchar(200), NTCN_CN longtext, NTCN_TM varchar(20),
  BH_NTCN_INTRVL varchar(100), FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime,
  LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime, PRIMARY KEY (NTCN_NO)
);
CREATE TABLE TB_INTNET_SVC (
INTNET_SVC_ID varchar(20) NOT NULL, INTNET_SVC_NM varchar(200), INTNET_SVC_DC longtext,
  REFLCT_AT varchar(1) DEFAULT 'N', FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime,
  LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime, PRIMARY KEY (INTNET_SVC_ID)
);
...
RECOMEND_SITE_ID varchar(20) NOT NULL, RECOMEND_SITE_URL varchar(300), RECOMEND_SITE_NM varchar(200),
  RECOMEND_SITE_DC longtext, RECOMEND_RESN_CN longtext, RECOMEND_CONFM_AT varchar(1) DEFAULT 'N',
  CONFM_DE varchar(20), FRST_REGIST_PNTTM datetime, FRST_REGISTER_ID varchar(20),
  LAST_UPDT_PNTTM datetime, LAST_UPDUSR_ID varchar(20), PRIMARY KEY (RECOMEND_SITE_ID)
);
CREATE TABLE TB_ROUGHMAP (
ROUGHMAP_ID varchar(20) NOT NULL, ROUGHMAPSJ varchar(200), ROUGHMAPADDRESS varchar(300),
  LA varchar(30), LO varchar(30), MARKERLA varchar(30), MARKERLO varchar(30), INFOWINDOW longtext, ZOOMLEVEL varchar(5),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
...
UNITY_LINK_ID varchar(20) NOT NULL, UNITY_LINK_SE_CODE varchar(20), UNITY_LINK_NM varchar(200),
  UNITY_LINK_URL varchar(300), UNITY_LINK_DC longtext,
  FRST_REGIST_PNTTM datetime, FRST_REGISTER_ID varchar(20), LAST_UPDT_PNTTM datetime, LAST_UPDUSR_ID varchar(20),
  PRIMARY KEY (UNITY_LINK_ID)
);
CREATE TABLE TB_SITE_LIST (
SITE_ID varchar(20) NOT NULL, SITE_URL varchar(300), SITE_NM varchar(200), SITE_DC longtext,
...
EVENT_ID varchar(20) NOT NULL, EVENT_SE varchar(20), EVENT_NM varchar(200), EVENT_PURPS longtext,
  EVENT_BGNDE varchar(20), EVENT_ENDDE varchar(20), EVENT_AUSPC_INSTT_NM varchar(100), EVENT_MNGT_INSTT_NM varchar(100),
  EVENT_PLACE varchar(200), EVENT_CN longtext, CT_OCCRRNC_AT varchar(1) DEFAULT 'N', PARTCPT_CT varchar(100),
...
RWARD_ID varchar(20) NOT NULL, RWARDWNR_ID varchar(20), RWARD_CODE varchar(20), RWARD_DE varchar(20), RWARD_NM varchar(200),
  PBLEN_CN longtext, SANCTNER_ID varchar(20), CONFM_AT varchar(1) DEFAULT 'N', SANCTN_DT varchar(20), RETURN_RESN longtext,
  ATCH_FILE_ID varchar(20), INFRML_SANCTN_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (RWARD_ID)
);
CREATE TABLE TB_NEWS_INFO (
NEWS_ID varchar(20) NOT NULL, NEWS_SJ varchar(200), NEWS_CN longtext, NEWS_ORIGIN varchar(200),
...
IMAGE_ID varchar(20) NOT NULL, IMAGE_NM varchar(200), IMAGE varchar(300), IMAGE_FILE varchar(300),
  IMAGE_DC longtext, REFLCT_AT varchar(1) DEFAULT 'N',
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
...
MTGRUM_ID varchar(20) NOT NULL, MTGRUM_NM varchar(200), OPN_BEGIN_TM varchar(10), OPN_END_TM varchar(10),
  ACEPTNC_POSBL_NMPR decimal(6), LC_SE varchar(20), LC_DETAIL varchar(300), ATCH_FILE_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (MTGRUM_ID)
);
CREATE TABLE TB_WORD_DICARY_INFO (
WORD_ID varchar(20) NOT NULL, WORD_NM varchar(200), ENG_NM varchar(200), WORD_DC longtext, SYNONM varchar(300),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (WORD_ID)
);
...
CNTNTS_ID varchar(20) NOT NULL, CNTNTS_NM varchar(200), CNTC_URL varchar(300), CNTNTS_USE_AT varchar(1) DEFAULT 'Y',
  CNTNTS_LINK_URL varchar(300), CNTNTS_DC longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (CNTNTS_ID)
);
CREATE TABLE TB_HPCM_INFO (
HPCM_ID varchar(20) NOT NULL, HPCM_SE_CODE varchar(20), HPCM_DFN varchar(300), HPCM_DC longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (HPCM_ID)
);
...
ADMINIST_WORD_ID varchar(20) NOT NULL, ADMINIST_WORD_NM varchar(200), ADMINIST_WORD_ENG_NM varchar(200),
  ...
  ADMINIST_WORD_DFN longtext, ADMINIST_WORD_DC longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (ADMINIST_WORD_ID)
);
CREATE TABLE TB_NOTE (
NOTE_ID varchar(20) NOT NULL, NOTE_SJ varchar(200), NOTE_CN longtext, ATCH_FILE_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (NOTE_ID)
);
...
OCCRRNC_YEAR varchar(4) NOT NULL, USER_ID varchar(20) NOT NULL,
  YRYC_OCCRRNC_CO decimal(5,1), USE_YRYC_CO decimal(5,1), REMNDR_YRYC_CO decimal(5,1),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
...
ANNVRSRY_ID varchar(20) NOT NULL, USER_ID varchar(20), ANNVRSRY_SE varchar(20), ANNVRSRY_NM varchar(200),
  ...
  MEMO longtext, REPTIT_AT varchar(1) DEFAULT 'N',
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (ANNVRSRY_ID)
);
CREATE TABLE TB_MTG_INFO (
MTG_ID varchar(20) NOT NULL, MTG_NM varchar(200), MTG_MTR_CN longtext, MTG_SN varchar(20), MTG_CO varchar(20),
  ...
  MTG_RESULT_CN longtext, MTG_RESULT_ENNC varchar(200), ETC_MATTER longtext,
  MNGT_DEPT_ID varchar(20), MNAER_ID varchar(20), MNAER_DEPT_ID varchar(20), MTG_AT varchar(1) DEFAULT 'N',
  NONATDRN_CO decimal(6), ATDRN_CO decimal(6),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (MTG_ID)
);
...
SRCHWRD_ID varchar(20) NOT NULL, SRCHWRD_MANAGE_ID varchar(20), SRCHWRD_NM varchar(200), SRCHWRD_CO decimal(10) DEFAULT 0,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (SRCHWRD_ID)
);
CREATE TABLE TB_EVENT_INFO (
EVENT_ID varchar(20) NOT NULL, BSNS_YEAR varchar(4), BSNS_CODE varchar(20),
  EVENT_SVC_BGNDE varchar(20), EVENT_SVC_ENDDE varchar(20), SVC_USE_NMPR_CO decimal(8), CHARGER_NM varchar(50),
  EVENT_CN longtext, EVENT_TY_CODE varchar(20), PRPARETG_CN longtext, EVENT_CONFM_AT varchar(1) DEFAULT 'N', EVENT_CONFM_DE varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (EVENT_ID)
);
...
POLL_ID varchar(20) NOT NULL, POLL_NM varchar(200), POLL_BGNDE varchar(20), POLL_ENDDE varchar(20),
  POLL_KND varchar(20), POLL_DSUSE_ENNC varchar(1) DEFAULT 'N', POLL_ATMC_DSUSE_ENNC varchar(1) DEFAULT 'N', QESITM_CN longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (POLL_ID)
);
...
ONLINE_MNL_ID varchar(20) NOT NULL, ONLINE_MNL_NM varchar(200), ONLINE_MNL_SE_CODE varchar(20),
  ONLINE_MNL_DFN varchar(500), ONLINE_MNL_DC longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (ONLINE_MNL_ID)
);
CREATE TABLE TB_CPYRHT_INFO (
CPYRHT_ID varchar(20) NOT NULL, CPYRHT_PRTC_POLICY_CN longtext,
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (CPYRHT_ID)
);
CREATE TABLE TB_CNSLT_LIST (
CNSLT_ID varchar(20) NOT NULL, CNSLT_SJ varchar(200), CNSLT_CN longtext, OTHBC_AT varchar(1) DEFAULT 'Y',
...
KNWLDG_ID varchar(20) NOT NULL, KNWLDG_NM varchar(200), KNWLDG_CN longtext, KNWLDG_TY_CODE varchar(20),
...
ANSWER_NO decimal(20) NOT NULL, NTT_ID decimal(20) NOT NULL, BBS_ID varchar(20) NOT NULL,
...
TODO_ID varchar(20) NOT NULL, TODO_SJ varchar(200), TODO_CN longtext, TODO_BEGIN_TIME varchar(20), TODO_END_TIME varchar(20), WRTER_ID varchar(20),
  FRST_REGISTER_ID varchar(20), FRST_REGIST_PNTTM datetime, LAST_UPDUSR_ID varchar(20), LAST_UPDT_PNTTM datetime,
  PRIMARY KEY (TODO_ID)
);
